  ...
  return (
    <PageWrapper>
      <div className="w-full min-h-[calc(100svh-80px)] md:min-h-[85vh] pt-10 flex flex-col items-center gap-12 px-4 md:px-10">
        ...
        <div className="w-full border-t border-gray-200 pt-8 pb-8 flex flex-col gap-8 max-w-6xl">
          
          <div className="w-full flex flex-col sm:flex-row justify-between items-center gap-6">
            <h1 className="text-white font-bold font-['Caveat'] text-3xl sm:text-3xl">
              Nikhil Singhal
            </h1>

            <div className="flex gap-8 text-4xl sm:text-3xl text-white">
              <a href="https://www.linkedin.com/in/nikhilsinghal6305/" target="_blank" rel="noreferrer">
                <FaLinkedin className="hover:text-red-500 hover:scale-110 transition-all" />
              </a>
              <a href="https://github.com/NIkhilSinghal6305" target="_blank" rel="noreferrer">
                <FaGithub className="hover:text-red-500 hover:scale-110 transition-all" />
              </a>
              <a href="mailto:nikhilagarwal6305@gmail.com">
                <FaEnvelope className="hover:text-red-500 hover:scale-110 transition-all" />
              </a>
            </div>
          </div>

          <p className="text-white opacity-60 text-sm sm:text-sm text-center font-['PT_Serif']">
